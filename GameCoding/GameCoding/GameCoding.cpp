...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszClassName = L"WookClass";
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HWND hWnd = CreateWindowW(L"WookClass", L"WookWindowsCoding", WS_OVERLAPPEDWINDOW,
